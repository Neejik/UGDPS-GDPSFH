...
$string["clanMembers"] = "Miembros del team";
$string["noMembers"] = "Sin miembros";
$string["clanOwner"] = "Dueño del team";
$string["noClanDesc"] = "<i>Sin descripción</i>";
$string["noClan"] = "Team no encontrado";
$string["clanName"] = "Nombre del team";
$string["clanTag"] = "Etiqueta del team (3-5 caracteres)";
$string["clanDesc"] = "Descripción del team";
$string["clanColor"] = "Color del team";
$string["dangerZone"] = "Zona de peligro";
$string["giveClan"] = "Transferir propiedad";
$string["deleteClan"] = "Eliminar team";
$string["goBack"] = "Volver";
$string["areYouSure"] = "¿Estás seguro?";
$string["giveClanDesc"] = "Transfiere la propiedad del team a otro miembro";
$string["notInYourClan"] = "Este miembro no está en tu team";
$string["givedClan"] = "Has transferido tu team a <b>%s</b> exitosamente";
$string["deletedClan"] = "Has eliminado el team <b>%s</b>";
$string["deleteClanDesc"] = "Elimina el team de forma permanente";
$string["yourClan"] = "Tu team";
...
$string["pendingRequests"] = "Solicitudes del team";
$string["closedClan"] = "Team privado";
$string["kickMember"] = "Expulsar miembro";
$string["leaveFromClan"] = "Abandonar team";
$string["askToJoin"] = "Enviar solicitud de unión";
$string["removeClanRequest"] = "Rechazar solicitud de unión";
$string["joinClan"] = "Unirse al team";
$string["noClans"] = "Aún no hay teams";
$string["clans"] = "Teams";
$string["alreadyInClan"] = "Ya formas parte de un team";
$string["createClan"] = "Crear team";
$string["createdClan"] = "Has creado un team exitosamente <span style='font-weight:700;color:#%s'>%s</span>";
$string["createClanDesc"] = "Crea un team";
$string["create"] = "Crear team";
$string["mainSettings"] = "Ajustes principales";
$string["takenClanName"] = "Este nombre de team ya está en uso";
$string["takenClanTag"] = "Esta etiqueta de team ya está en uso";
// idk
...
$string["modAction17"] = "Map Zone creado";
$string["modAction18"] = "Capítulo creado";
$string["modAction19"] = "Canción cambiada";
$string["modAction20"] = "Ascendido un usuario a Moderador";
$string["modAction21"] = "Map Zone editado";
$string["modAction22"] = "Capítulo editado";
